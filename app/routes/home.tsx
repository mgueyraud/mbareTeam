...
export const action = async ({ request, params }: ActionArgs) => {
  ...
  try {
    ...
    await sendEmail({
      ...
      to: updatedContent.User?.email ?? "",
      subject: `Se ha registrado un like ${updatedContent.title}`,
      html: `
          <h1>Proyecto "${updatedContent.title}"</h1>
          <p>Se ha registrado un like mas</p>
          <b>Total de likes: ${Number(likeCount)}</b>
      `,
    });
            ...
            <Card className="w-[350px]">
              ...
              <Form method="POST">
                ...
                <CardFooter>
                  ...
                  >
                    <span className="text-sm mr-2">{content.likeCount}</span>
                    <ThumbsUp size={20} />
                  </Badge>
                </CardFooter>
              </Form>
