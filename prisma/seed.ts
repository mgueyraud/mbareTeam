...
async function main() {
  ...
  const userJavier = await prisma.user.create({
    data: {
      ...
      name: "Lopez",
      picture:
        "https://lh3.googleusercontent.com/a/AAcHTtdKkhn0ckrzWO_str86R90QGALfPe3Ro8u-cvd3DvYpri-a=s96-c",
      username: "rafa",
      description: "",
    },
  });
  ...
  await prisma.user.create({
    data: {
      ...
      name: "Gueyraud",
      picture:
        "https://lh3.googleusercontent.com/a/AAcHTtdMFYPY1s2tLZftY6ZVDjYMi6vjEBNDMheEDpdvlc8n0mY=s96-c",
      username: "mario",
      description: "",
    },
  });
